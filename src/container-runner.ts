...
function buildVolumeMounts(
  ...
  if (isMain) {
    ...
    // Note: .env shadowing via /dev/null mount doesn't work with Apple Container.
    // Credentials are safely injected by the credential proxy, never exposed to containers.
